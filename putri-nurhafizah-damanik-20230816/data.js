...
// Nama Panggilan
namaCover.textContent = 'Halo, Pija';

// Nama Lengkap
namaLengkap.forEach(function(element) {
	element.textContent = "Putri Nurhafizah Damanik";
});

// Nama Gelar
namaGelar.forEach(function(element) {
	element.textContent = "S.Pd";
});

// Program Studi
prodi.textContent = 'Prodi Manajemen Pendidikan Islam';
...
// Foto bingkai
fotoBingkai.style.backgroundImage = 'url(../putri-nurhafizah-damanik-20230816/pija0.jpg)';
...
fotoSempro.forEach(function(element) {
	element.style.backgroundImage = 'url(../putri-nurhafizah-damanik-20230816/pija2.jpg)';
	element.style.backgroundPosition = 'center';
	element.style.backgroundSize = 'cover';
});
...
fotoKompri.forEach(function(element) {
	element.style.backgroundImage = 'url(../putri-nurhafizah-damanik-20230816/pija1.jpg)';
	element.style.backgroundPosition = 'center';
	element.style.backgroundSize = 'cover';
});
