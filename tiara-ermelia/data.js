...
fotoCoverHeader.forEach(function(element) {
	element.style.backgroundImage = 'url(tiara3.jpeg)';
	element.style.backgroundPosition = 'center';
	element.style.backgroundSize = 'cover';
});

// Foto bingkai
fotoBingkai.style.backgroundImage = 'url(tiaraa.jpeg)';
...
fotoSempro.forEach(function(element) {
	element.style.backgroundImage = 'url(tiara1.jpeg)';
	element.style.backgroundPosition = 'center';
	element.style.backgroundSize = 'cover';
});
...
fotoKompri.forEach(function(element) {
	element.style.backgroundImage = 'url(tiara2.jpeg)';
	element.style.backgroundPosition = 'center';
	element.style.backgroundSize = 'cover';
});
